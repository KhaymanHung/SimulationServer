...
CREATE TABLE `player` (
  ...
  `playerId` varchar(45) COLLATE utf8mb4_bin NOT NULL COMMENT '玩家id，同lobby.account.playerId',
  `agentId` varchar(45) COLLATE utf8mb4_bin DEFAULT '' COMMENT '代理商id，同lobby.account.agentId',
